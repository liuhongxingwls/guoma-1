...
0
|| checktplrefresh('./template/guoma/common/header.htm', './template/guoma/common/header_common.htm', 1388328955, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/guoma', 'common/header_forum_forumdisplay')
;?>
...
<div class="z_header">
            <?php $mnid = getcurrentnav();?><div class="z_top">
                <img src="<?php echo IMGDIR;?>/logo1.jpg" style="float:left; margin-right:20px;"/>

<div class="z_menu">
    <?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { ?>                        <?php if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) )) { ?><a href="<?php echo $nav['filename'];?>" <?php if($mnid == $nav['navid']) { ?>class="z_menu_hover"<?php } ?>><?php echo $nav['navname'];?></a> <?php } ?>
                    <?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?>
</div>
                <div class="z_login"><a>退出登录</a></div>
</div>
</div>
